...
const allMortgageProgramPages: SeoPage[] = [
  ...
  },
  {
    ...
    metaDescription: "Explore Texas VA loan options for eligible veterans, active-duty service members, and qualifying spouses with Source One Home Loans.",
    keywords: ["Texas VA Loans", "VA mortgage Texas", "VA home loan Texas", "Texas mortgage options"],
    ...
    benefits: ["VA eligibility discussion", "Clear mortgage guidance", "Purchase and refinance planning"],
  ...
  },
  {
    ...
    keywords: ["VA Loan Benefits for Veterans", "Texas VA Loans", "VA home loan Texas"],
    eyebrow: "VA Loan Education",
    intro:
      "VA loan benefits may help eligible military borrowers purchase or refinance a home with features designed around service member and veteran home financing needs.",
    ...
    benefits: ["VA benefit review", "Texas homebuyer planning", "Clear mortgage support"],
  ...
  },
  {
    ...
    keywords: ["VA Loan Eligibility Guide", "Texas VA Loans", "VA home loan Texas"],
    eyebrow: "VA Loan Education",
    intro:
  ...
  },
  {
    ...
    benefits: ["Side-by-side program discussion", "Payment and cash-to-close planning", "Clear mortgage guidance"],
  ...
  },
  {
    ...
    keywords: ["VA Loan Funding Fee", "Texas VA Loans", "VA home loan Texas"],
    eyebrow: "VA Loan Education",
    intro:
...
const veteranHomeownershipPosts: BlogPost[] = [
  {
    ...
    date: "2026-06-07",
    readTime: "7 min read",
    keywords: ["Texas VA Loans", "VA loan benefits", "VA home loan Texas"],
    takeaways: [
      ...
      "Source One Home Loans can help borrowers compare VA benefits with other loan options.",
    ],
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "These questions do not make the process more complicated; they make it more honest. A good mortgage conversation should help borrowers understand the benefit, the responsibilities, and the alternatives. Source One Home Loans uses that approach so eligible borrowers can move toward pre-qualification with clear expectations.",
        ],
      },
      {
  ...
  },
  {
    ...
    date: "2026-06-07",
    readTime: "7 min read",
    keywords: ["VA loan myths", "Texas VA Loans", "VA home loan Texas"],
    takeaways: [
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Source One Home Loans brings a service-oriented perspective to VA loan guidance. Borrowers can start with a pre-qualification conversation, compare VA with conventional or jumbo options where appropriate, and move forward with facts instead of assumptions.",
        ],
      },
      {
  ...
  },
  {
    ...
    date: "2026-06-07",
    readTime: "8 min read",
    keywords: ["VA no down payment", "Texas VA Loans", "VA home loan Texas"],
    takeaways: [
  ...
  },
  {
    ...
    takeaways: [
      ...
      "A clear mortgage consultation can help clarify the tradeoffs.",
    ],
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "A clear mortgage review can help eligible military borrowers compare VA benefits with conventional and jumbo options without losing sight of the service-related advantages. The goal is to understand which path fits the property, the borrower, and the long-term plan.",
        ],
      },
      {
  ...
  },
  {
    ...
    date: "2026-06-07",
    readTime: "8 min read",
    keywords: ["Texas Veterans Home Buying Guide", "Texas VA Loans", "VA home loan Texas"],
    takeaways: [
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Source One Home Loans helps borrowers connect eligibility questions to the practical homebuying process. That includes reviewing income, debts, credit, assets, payment comfort, and whether VA, conventional, or jumbo financing should be compared. Clear guidance can help translate the benefit into a plan that makes sense for the Texas market.",
        ],
      },
      {
  ...
  },
  {
    ...
    date: "2026-06-07",
    readTime: "7 min read",
    keywords: ["military relocation mortgage", "Texas VA Loans", "VA home loan Texas"],
    takeaways: [
      ...
      "Source One Home Loans can help military families plan with practical next steps.",
    ],
