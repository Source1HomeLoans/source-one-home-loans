  ...
  <tr>
    <td style="padding:8px 10px;">
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="width:100%;border-collapse:collapse;">
        <tr>
          <td valign="middle" style="width:145px;padding:0 10px 0 0;">
            <a href="https://www.sourceonehomeloans.com" style="text-decoration:none;">
              <img src="https://www.sourceonehomeloans.com/branding/logo/source-one-email-logo.png" width="135" alt="Source One Home Loans" style="display:block;width:135px;max-width:100%;height:auto;border:0;outline:none;text-decoration:none;">
            </a>
          </td>
